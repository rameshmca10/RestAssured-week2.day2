...
public class GetAllIncidentsXML {
	...
	public void getAllIncidents() {
		...
		Response response = RestAssured.given().queryParams(queryParams).accept(ContentType.XML).get();

		List<String> list = response.xmlPath().getList("response.result.sys_id");
